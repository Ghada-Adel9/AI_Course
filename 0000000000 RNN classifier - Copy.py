...
if __name__ == "__main__":
    ...
    # speakers_list =['neutral','calm','happy','sad','angry','fearful','disgust','surprised', '9', '10', '11', '12']
    # speaker_name = [emotion for emotion in speakers_list]
    ...
    sn.set(font_scale=1.5) # emotion label and title size
    plt.subplot(1,2,1)
